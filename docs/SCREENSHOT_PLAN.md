...
5. **Global administration** — retention, refresh, heartbeat, stale threshold and incident-limit settings.

## Capture rules

- Use the standard Moodle 4.5 theme or state the theme used.
- Capture at a readable desktop width; add one mobile image only if the layout has been tested.
- Keep browser chrome out unless it explains a workflow.
- Do not edit screenshots in a way that changes plugin behaviour.
- Crop empty areas but preserve relevant Moodle context.
- Use descriptive filenames: `01-quiz-settings.png`, `02-student-warning.png`, etc.
- Add concise English alt text and an optional Spanish caption.
- Recheck every image at full resolution before publishing.
