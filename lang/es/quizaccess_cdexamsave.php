...
/**
 * Spanish language strings for CDexamSave.
 *
...
$string['pluginname'] = 'Supervisión de foco CDexamSave';
$string['formheader'] = 'CDexamSave: supervisión del foco';
...
$string['monitoringnotice'] = 'La supervisión CDexamSave está activada. Si se abandona esta pestaña o ventana del cuestionario, quedará registrado y se comunicará al profesorado autorizado.';
...
$string['openlivereport'] = 'Abrir informe en directo de CDexamSave';
...
$string['cdexamsave:viewreport'] = 'Ver el informe en directo de CDexamSave';
$string['cdexamsave:exportreport'] = 'Exportar los incidentes de CDexamSave';

$string['livereport'] = 'Informe en directo de CDexamSave';
...
$string['reportdisabled'] = 'CDexamSave no está activado actualmente en este cuestionario.';
...
$string['notificationtitle'] = 'CDexamSave: nuevo incidente de foco';
...
$string['pollerror'] = 'No se han podido actualizar los datos en directo. CDexamSave volverá a intentarlo automáticamente.';
...
$string['taskcleanup'] = 'Eliminar datos de supervisión caducados de CDexamSave';
$string['invalidrequest'] = 'Solicitud de supervisión CDexamSave no válida.';
$string['monitoringdisabled'] = 'CDexamSave no está activado para este cuestionario.';
...
$string['privacy:path'] = 'Supervisión del foco CDexamSave';
